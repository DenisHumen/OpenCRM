...
# делаем при лежащем Redis — `docs/ekspluatatsiya/08-razvyortyvanie.md`, «Память на разжатии
...
def mesto_razzhatiya():
    ...
    известна и посчитана (`docs/ekspluatatsiya/08-razvyortyvanie.md`): четыре процесса по два
