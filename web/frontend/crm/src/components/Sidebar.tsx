...
export function Sidebar({
  ...
  const admin = allowed<NavItem>(user, modules, [
    ...
    // Файлы — свой блок: дерево показывает весь диск, а не медиа досок, и
    // выключенное портфолио не должно прятать вложения клиентов вместе с ним.
    { module: "files", perm: "files.view", to: "/files", label: t("files"), icon: "folder" },
