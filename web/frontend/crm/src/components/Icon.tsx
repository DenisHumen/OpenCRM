/* Иконки — line-art 24×24, штрих 1.5, как в макетах (стиль Lucide). */
...
const PATHS: Record<string, string> = {
  ...
  // Воронка: сделки сужаются от заявки к закрытию — тот же образ, что и в
  // отчёте по этапам, поэтому раздел узнаётся без подписи.
  deals: '<path d="M3 4h18l-7 8v7l-4 2v-9z"/>',
  staff:
  ...
  // Направление звонка читается стрелкой у трубки: входящий — к себе,
  // исходящий — от себя, пропущенный — перечёркнутый крестом.
  callIn:
  ...
  callOut:
    '<path d="M22 8V2h-6"/><path d="m16 8 6-6"/><path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384"/>',
  callMissed:
    '<path d="m22 2-6 6"/><path d="m16 2 6 6"/><path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384"/>',
  meeting:
  ...
  // Бланк — квитанция с оторванным краем: тот же образ, что у человека в руках.
  receipt:
    '<path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1z"/><path d="M8 7h8"/><path d="M8 11h8"/><path d="M8 15h5"/>',
  // Своё юрлицо — здание с окнами и пристройками: не «клиент» и не «доска», а
  // контора, от имени которой выставляют счёт.
  building:
  ...
  // Ящик (настройка), в отличие от `email` (конверт — само письмо)
  inbox:
