  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        // справочник набрался бы двойниками, молча и правдоподобно. Ошибка
        // при этом на стороне ручки, а вреда — на стороне того, кто читает
        // список: двойник выглядит как настоящая запись.
