 ...
 *
 * Считаем метрами на пиксель: пока в пикселе больше двадцати метров, улица
 * тоньше пикселя, и город превращается в серое пятно — рисовать нечего, а
 * запросов наружу ушло бы на весь экран.
 */
export const PREDEL_METROV = 20;

/** Больше этого за раз не просим: человек возит планету, а не изучает квартал. */
export const PREDEL_PLITOK = 12;
