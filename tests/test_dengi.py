...
Список файлов не ведётся руками — он собирается по упоминанию `_minor`. Список,
...
#: Признак денежной или количественной колонки в исходнике.
PRIZNAK = "_minor"
