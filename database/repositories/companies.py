...
частичным уникальным индексом. Причин две. Частичных индексов в MySQL нет вовсе,
то есть выразить такой инвариант схемой попросту нечем. Обычный же UNIQUE на
колонку не заменяет его ничем — он запретил бы двум фирмам одновременно НЕ быть
