...
# заводилась: строка длиннее колонки, которую SQLite примет молча, а MySQL
# отвергнет ошибкой.
TITLE_LENGTH = 120
HOST_LENGTH = 255
ADDRESS_LENGTH = 320
...
class MailMessage(Base):
    ...
    __table_args__ = (
        ...
        #
        # Индекс, а не UNIQUE-ограничение: в MySQL это одно и то же, а в SQLite
        # ограничение пришлось бы навешивать пересозданием таблицы. Длина под
        # MySQL считается так: 320 знаков utf8mb4 — 1280 байт, плюс int — 1284,
